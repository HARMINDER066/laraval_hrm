      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Leave</div>
        ...
        <div class="col-lg-12 mb-3 mb-lg-0">
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Edit Leave</h4>
            </div>
            <!-- End Header -->
...
@endif
          <form class="py-md-5" method="post" action="{{route('vendor.leave.editsave',$leave->id)}}">
              @csrf
               <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                          <select class="form-control" name="employee_id">
                            ...
                            <option value="{{$data->id}}" {{$leave->user->id == $data->id  ? 'selected' : ''}}>{{$data->first_name}} {{$data->last_name}}</option>
                            @endforeach
                          </select>
                      </div>
                    </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="form-control" name="leave_reason" value="{{$leave->leave_reason}}" id="lastNameLabel" placeholder="Enter Leave Reason" aria-label="Boone">
                      </div>
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" name="datefrom" value="{{$leave->datefrom}}"id="emailLabel"  aria-label="clarice@site.com">
                    </div>
                  </div>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" name="dateto" value="{{$leave->dateto}}"id="emailLabel"  aria-label="clarice@site.com">
                    </div>
                  </div>
                  ...
                  <div class="js-add-field row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <textarea  class="js-input-mask form-control" name="description" id="phoneLabel" placeholder="Enter Package Feature">{{$leave->description}}</textarea>
                          </div>
                    </div>
