...
@endif
          <form class="py-md-5" action="{{route('vendor.users.editsave',$user->id)}}"  method="POST" enctype="multipart/form-data">
               @csrf
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="form-control" name="first_name" value="{{$user->first_name}}" id="firstNameLabel" placeholder="Enter First Name" aria-label="Clarice">
                        <input type="text" class="form-control" name="last_name" value="{{$user->last_name}}" id="lastNameLabel" placeholder="Enter Last Name" aria-label="Boone">
                      </div>
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="organization" value="{{$user->organization}}"  id="organizationLabel" placeholder="Enter Organization" aria-label="Htmlstream">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="department" value="{{$user->department}}"  id="departmentLabel" placeholder="Enter Department" aria-label="Human resources">
                    </div>
                  </div>
                  <!-- End Form -->
                      ...
                      <div class="input-group input-group-sm-vertical">
                        ...
                        <label class="form-control" for="userAccountTypeRadio1">
                          <span class="form-check">
                            <input type="radio" class="form-check-input" name="account_type" value="{{$user->account_type}}" id="userAccountTypeRadio1" {{$user->account_type == 'Individual'  ? 'checked' : ''}} value="Individual">
                        ...
                        <label class="form-control" for="userAccountTypeRadio2">
                          <span class="form-check">
                            <input type="radio" class="form-check-input" name="account_type" id="userAccountTypeRadio2" {{$user->account_type == 'Company'  ? 'checked' : ''}} value="Company">
