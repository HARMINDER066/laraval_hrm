    ...
    var table = $('#example_datatables_new').DataTable({
        ...
        columns: [
            ...
            {data: 'feature', name: 'feature'},
             {data: 'no_employee', name: 'no_employee'},
...
function load_active_inactive()
    {
        var elems = Array.prototype.slice.call(document.querySelectorAll('.package_status_change'));
        ...
        $(".package_status_change").change(function () {
            ...
            var url = "{!! route('admin.package.active_inactive') !!}";
            $.ajax({
                url: url,
                data:{
                    id:id,
                ...
                if (data == 1) {
                    ...
                    type: 'success',
                    timer: 3000,
                    title: "Package Active Succesfully"
                })
                    ...
                    type: 'success',
                    timer: 3000,
                    title: "Package InActive Succesfully"
                })
                    }
                } else {
                      Swal.fire({
