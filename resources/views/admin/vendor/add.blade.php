      ...
      <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Add Vendor</div>
        ...
        <div class="col-lg-12 mb-3 mb-lg-0">
          ...
          <div class="card mb-3 mb-lg-5">
            ...
            <div class="card-header">
              <h4 class="card-header-title">Add Vendor</h4>
            </div>
            <!-- End Header -->
...
@endif
          <form class="py-md-5" method="post" action="{{route('admin.vendoraddsubmit')}}" enctype="multipart/form-data">
               @csrf
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <div class="input-group input-group-sm-vertical">
                        <input type="text" class="form-control" name="name" id="firstNameLabel" placeholder="Enter  Name" aria-label="Clarice">
                      </div>
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <textarea type="text" class="form-control" name="address" id="address" placeholder="Enter Address" aria-label="clarice@site.com"> Enter Address</textarea>
                    </div>
                  </div>
                      <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="date" class="form-control" name="date_of_birth" id="organizationLabel" placeholder="Enter DOB" aria-label="Htmlstream">
                    </div>
                  </div>
                  <!-- End Form -->
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-9">
                      <input type="text" class="form-control" name="company_name" id="departmentLabel" placeholder="Enter Company Name" aria-label="Human resources">
                    </div>
                  </div>
                  <div class="row mb-4">
