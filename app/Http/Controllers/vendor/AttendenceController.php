       ...
       if ($request->ajax()) {
            ...
            return Datatables::of($data)
                    ...
                    ->addColumn('action', function($data){
                            ...
                            $btn = '<a class="mx-1 ajaxviewmodel" href="' . route('vendor.users.edit_attendence', ['id' => $data->id]) . '"><i class="fadeIn animated bx bx-edit-alt"></i></a>';
                              $btn .= '<a href="javascript:void(0)" data-value = "' . route('vendor.users.attendence_delete', ['id' => $data->id]) . '" class="mx-1 delete_customer"><i class="fadeIn animated bx bx-trash-alt"></i></a>';
        ...
        return view('vendor.attendence.index');
    }
